...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"C:\Users\ADMIN\Desktop\face_recognition system\college_images\low.jpg")
        ...
        # second image
        img1=Image.open(r"C:\Users\ADMIN\Desktop\face_recognition system\college_images\ddd4.jpg")
        ...
        # third image
        img2=Image.open(r"C:\Users\ADMIN\Desktop\face_recognition system\college_images\facialrecognition22.jpg")
        ...
        # bg imahe
        img3=Image.open(r"C:\Users\ADMIN\Desktop\face_recognition system\college_images\boruto.jpg")
        ...
        img_left=Image.open(r"C:\Users\ADMIN\Desktop\face_recognition system\college_images\123.jpg")
        ...
        dep_combo["values"]=("Select Department","Computer Science Engineering","IT","Civil Engineering","Mechnical Engineering","Electrical Engineering","B.A + Psychology","BCA")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select course","Computer Science Engineering","IT","Civil Engineering","Mechnical Engineering","Electrical Engineering","B.A + Psychology","BCA")
        ...
        semester_combo["values"]=("Select Semester","Semester-1","Semester-2","Semester-3","Semester-4","Semeste-5r","Semester-6","Semester-7","Semester-8")
        ...
        teke_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=35,font=("times new roman",13,"bold"),bg="blue",fg="white")
        teke_photo_btn.grid(row=0,column=0)
        ...
        img_right=Image.open(r"C:\Users\ADMIN\Desktop\face_recognition system\college_images\kv_01.jpg")
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","roll","gender","div","dob","email","phone","address","teacher","photo"),xscrollcomman=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","Student datails has been added Successfully",parent=self.root)
